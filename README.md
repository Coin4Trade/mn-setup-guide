...
# Coin4Trade Masternode Setup Guide (Ubuntu 16.04 or 18.04)
This guide will assist you in setting up a Coin4Trade Masternode on a Linux Server running Ubuntu.
...
2) **VPS (Vultr) running Linux Ubuntu**
...
```
wget https://github.com/Coin4Trade/Coin4Trade/releases/download/C4T-v2.0/C4T-2.0-linux-x64.tar
```
...
```
tar -xvf C4T-2.0-linux-x64.tar
cd C4T-2.0-linux-x64
chmod -f 777 C4Td
chmod -f 777 C4T-cli
chmod -f 777 C4T-tx
./C4Td -daemon
